          ...
          <div className="space-y-4">
            <div className="flex gap-4 items-center">
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                />
                <DialogContent className="max-w-3xl bg-[#1C1B1B] border-primary/20 p-12 shadow-[0_0_80px_rgba(0,0,0,0.6)] border-l-8 border-l-primary overflow-y-auto max-h-[90vh]">
