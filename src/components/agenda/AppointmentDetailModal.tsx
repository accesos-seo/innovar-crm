...
export function AppointmentDetailModal({
  ...
  // time_slot like "14:00" -> "14:00 - 15:30" (1.5h)
          ...
          <div className="space-y-3">
              <div className="flex items-center gap-2">
                 ...
                 <span className={`px-2 py-0.5 rounded-full border text-[10px] font-bold uppercase tracking-wider
                    ${appointment.status === 'completado' ? 'border-primary text-primary bg-primary/10' : 'border-orange-500 text-orange-500 bg-orange-500/10'}
                 `}>
