...
export const motorComercialAgentes: MotorAgente[] = [
  {
    ...
    emoji: '🎯',
    descripcion: 'Captura leads de todos los canales (web, WhatsApp, referidos, sala de exhibición), crea el registro automáticamente y asigna el comercial por turno rotativo (round-robin). Es el punto de entrada del pipeline.',
    cuando_se_activa: 'Cada vez que llega un lead nuevo desde cualquier canal',
    que_produce: 'Lead registrado + oportunidad creada + comercial asignado + slot de visita propuesto',
    status: 'activo',
    ...
    fases: [
      ...
      { id: 3, label: 'Asignación round-robin',  detalle: 'Consulta el turno activo y asigna el comercial correspondiente.', status: 'completed' },
  ...
  },
  {
    ...
    fases: [
      ...
      { id: 5, label: 'Notificaciones',            detalle: 'WhatsApp al cliente ("tu proyecto ha comenzado") y al diseñador.', status: 'completed' },
