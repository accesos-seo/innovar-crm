...
export const motorComercialAgentes: MotorAgente[] = [
  ...
  },
  {
    ...
    fases: [
      { id: 1, label: 'Inicio de fabricación',     detalle: 'Cuando el equipo registra fabrication_started_at, envía WA al cliente: "Tu cocina está siendo fabricada".', status: 'pending' },
      { id: 2, label: 'Instalación programada',    detalle: 'Cuando se registra scheduled_install_date, envía WA de confirmación con la fecha exacta.', status: 'pending' },
      { id: 3, label: 'Recordatorio día D',         detalle: 'Cron 7:30am — si hay instalaciones hoy, envía WA al cliente y crea tarea interna al instalador.', status: 'pending' },
    ],
  },
  {
    id: 'cierre-proyecto',
    ...
    fases: [
      { id: 1, label: 'Verificación de condiciones', detalle: 'Trigger verifica que delivered_at sea NOT NULL Y is_fully_paid = true. Si hay saldo pendiente, no actúa.', status: 'pending' },
      { id: 2, label: 'Cierre formal',               detalle: 'UPDATE projects SET status = "completado". Guard idempotente: no vuelve a ejecutar si ya está cerrado.', status: 'pending' },
      { id: 3, label: 'WhatsApp al cliente',          detalle: 'Encola mensaje con template proyecto_completado_v1: agradecimiento por el proyecto.', status: 'pending' },
      { id: 4, label: 'Tarea de reseña',              detalle: 'INSERT en tasks: "Solicitar reseña — [cliente]", asignada al responsable del proyecto, vence en 7 días.', status: 'pending' },
    ],
  },
];
