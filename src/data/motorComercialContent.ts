...
export const motorComercialAgentes: MotorAgente[] = [
  ...
  },
  {
    ...
    fases: [
      ...
      { id: 4, label: 'Encolar WhatsApp',             detalle: 'Trigger y enqueue implementados. Activa cuando Robert cree el template proyecto_iniciado_v1 en Meta BM.', status: 'pending' },
    ],
  },
  {
  ...
  {
    id: 'monitor-produccion',
    nombre: 'Monitor de Producción',
    emoji: '🔨',
    descripcion: 'Mantiene al cliente informado durante toda la fase de fabricación e instalación: avisa cuando empieza la fabricación, confirma la fecha de instalación y recuerda el día que llega el equipo.',
    cuando_se_activa: 'Tres momentos clave: cuando inicia la fabricación, cuando se agenda la instalación, y la mañana del día de instalación',
    que_produce: 'WhatsApps automáticos al cliente en cada hito de producción + recordatorio el día de la instalación',
    status: 'activo',
    tecnologia: 'PostgreSQL Triggers (AFTER UPDATE) + n8n Cron + Meta WhatsApp API',
    fases: [
      { id: 1, label: 'Inicio de fabricación',     detalle: 'Cuando el equipo registra fabrication_started_at, envía WA al cliente: "Tu cocina está siendo fabricada". Template: fabricacion_iniciada_v1.', status: 'completed' },
      { id: 2, label: 'Instalación programada',    detalle: 'Cuando se registra scheduled_install_date, envía WA de confirmación con la fecha exacta en español. Template: instalacion_programada_v1.', status: 'completed' },
      { id: 3, label: 'Recordatorio día D',         detalle: 'Cron 7:30am (n8n CjbwjGdRKyIzWJWq) — si hay instalaciones hoy, envía WA al cliente y crea tarea interna al instalador. Template: recordatorio_instalacion_v1.', status: 'completed' },
    ],
  },
  {
    id: 'cierre-proyecto',
    ...
    emoji: '🎊',
    descripcion: 'Cuando el equipo registra la entrega final de una cocina completamente pagada, el sistema cierra el proyecto, envía un WhatsApp de agradecimiento al cliente y crea la tarea de solicitar reseña.',
    cuando_se_activa: 'Cuando se registra la entrega (delivered_at) y el proyecto está completamente pagado (is_fully_paid = true)',
    que_produce: 'Proyecto cerrado + WhatsApp de agradecimiento al cliente + tarea "Solicitar reseña" en el Kanban del responsable',
    status: 'activo',
    tecnologia: 'PostgreSQL Trigger (AFTER UPDATE) + Meta WhatsApp API',
    fases: [
      { id: 1, label: 'Verificación de condiciones', detalle: 'Trigger verifica que delivered_at sea NOT NULL Y is_fully_paid = true. Si hay saldo pendiente, no actúa.', status: 'completed' },
      { id: 2, label: 'Cierre formal',               detalle: 'UPDATE projects SET status = "completado". Guard idempotente: no vuelve a ejecutar si ya está cerrado.', status: 'completed' },
      { id: 3, label: 'WhatsApp al cliente',          detalle: 'Encola mensaje con template proyecto_completado_v1: agradecimiento y confirmación de entrega del proyecto.', status: 'completed' },
      { id: 4, label: 'Tarea de reseña',              detalle: 'INSERT en tasks: "Solicitar reseña — [cliente]", asignada al responsable del proyecto, vence en 7 días.', status: 'completed' },
    ],
  },
];
